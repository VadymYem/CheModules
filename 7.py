...
class SpotifyMod(loader.Module):
    ...
    strings = {
        ...
        "playing": "<emoji document_id=6319076999105087378>🎧</emoji> <b>Грає...</b>",
        "back": (
            "<emoji document_id=5469735272017043817>👈</emoji> <b>Переключено на попередній"
            " трек</b>"
        ),
        ...
        "restarted": (
            "<emoji document_id=5469735272017043817>👈</emoji> <b>Відтворення треку з "
            " початку</b>"
        ),
        "auth": (
        ...
        "liked": (
            "<emoji document_id=5199727145022134809>❤️</emoji> <b>Теперішній трек додано"
            " до улюблених</b>"
        ),
        "autobio": (
        ...
        "currently_on": "Зараз прослуховується на",
        "playlist": "Плейлист",
        "owner": "Виконавець",
        "quality": "Якість",
    }
